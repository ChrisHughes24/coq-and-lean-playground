...
There is a notion given by the Logical Relations and Parametricity paper of reflexive graph category.
...
\subsection{Find the correct notion of morphism of a parametric category weaker than functor, but
