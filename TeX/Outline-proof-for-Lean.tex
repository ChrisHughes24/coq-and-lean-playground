...
\title{Amalgamated Products}
\author{Christopher Hughes}

\begin{document}
\begin{itemize}
\item First define the amalgamated product as a quotient of the coproduct (also called free product) of groups.
Both coproducts of groups and quotients of groups are already in mathlib.
\end{itemize}
