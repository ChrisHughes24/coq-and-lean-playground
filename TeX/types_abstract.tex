...
The problem was to interpret a term written in Lean in a linear lambda calculus and then interpret this term
in a symmetric closed category. Linear lambda calculus can be interpreted in a symmetric monoidal closed category,
